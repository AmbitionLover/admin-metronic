...
import work.ambitlu.system.service.ISysDeptService;
...
public class SysDeptController extends BaseController
{
    ...
    {
        List<Jstree> jstrees = deptService.selectDeptTree(new SysDept());
        return jstrees;
    }
    ...
    @ResponseBody
    public List<Jstree> deptTreeData(SysRole role)
    {
        List<Jstree> jstrees = deptService.roleDeptTreeData(role);
        return jstrees;
    }
}
