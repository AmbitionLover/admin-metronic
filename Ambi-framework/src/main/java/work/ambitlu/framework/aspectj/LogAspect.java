package work.ambitlu.framework.aspectj;

import work.ambitlu.common.annotation.Log;
import work.ambitlu.common.enums.BusinessStatus;
import work.ambitlu.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(work.ambitlu.common.annotation.Log)")
